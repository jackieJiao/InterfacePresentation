...
//var ExcelBuilder = require('./excel-builder.dist');
//var lodash = require('./lodash');
function exportPage(strPrintName, printDatagrid,getalldataurl) {
...
/*		 console.info("next is json from response");
		 console.info(r);*/
		 var rows =data.data;
		 var json1=rows.rows;
		 console.info(json1);
		 console.info("解析json1成数组");
		 var stuff = [];
      ...
      var columns111 = [[111,222,333],[444,555,666]];
      var originalData = stuff;
      console.info("stuff");
